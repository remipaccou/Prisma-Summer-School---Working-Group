...
ax.set_title("The ensemble missed 2025:\nreality exceeded most projections")
...
ax.set_title("Net-zero scenarios systematically\nunderestimate emissions")
...
ax.set_title("A straight line beats the ensemble\non 4 out of 6 variables")
