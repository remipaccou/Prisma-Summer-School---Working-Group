...
- LASSO logistic regression confirms which variables carry discriminating power (L1 penalty drops the rest to zero)

## Slide 5 — PV cost projection to 2070: Wright's law

- Wright's law: cost declines as a power of cumulative production (learning rate estimated via OLS on log-log)
